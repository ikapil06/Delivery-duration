"""
Main script for Delivery Duration Prediction Project
"""
...
class DeliveryDurationPredictor:
    ...
    def run_complete_pipeline(self):
        ...
        print("="*60)
        print("DELIVERY DURATION PREDICTION PIPELINE")
        print("="*60)
        
        # Step 1: Data Preprocessing
        print("\n1. DATA PREPROCESSING")
        print("-" * 30)
        self.raw_data = self.preprocessor.preprocess()
        self.processed_data = self.raw_data.copy()
        
        # Step 2: Feature Engineering
        print("\n2. FEATURE ENGINEERING")
        print("-" * 30)
        self.features_data = self.feature_engineer.engineer_features(self.processed_data)
    ...
    def run_two_stage_approach(self):
        ...
        self.results['two_stage_approach'] = {
            ...
            'simple_sum_rmse': np.sqrt(mean_squared_error(y_test_final, pred_df['sum_total_delivery_duration'].iloc[:len(y_test_final)]))
        }
    ...
    def generate_comparison_report(self, report_dir):
        ...
        with open(report_path, 'w') as f:
            f.write("DELIVERY DURATION PREDICTION - COMPARISON REPORT\n")
            f.write("=" * 60 + "\n\n")
    ...
    def save_results(self, report_dir):
        ...
        if 'two_stage_approach' in self.results:
            ...
            pred_df = pd.DataFrame({
                'actual': self.results['two_stage_approach']['final_predictions'],
